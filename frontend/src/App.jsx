...
export default function App() {
  ...
  const handleGenerateDashboard = () =>
    dashExport.run(async () => {
      if (!dashboard.loaded) throw new Error("Önce Excel yükleyin.");
      const pptx = buildDashboardDeck(dashboard.dashData, ASSETS);
  ...
  return (
    <>
      ...
      <DashboardPage visible={mode === "dash"} dashboard={dashboard} assets={ASSETS} onZoom={openZoom} />
